      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Als geregistreerd gebruiker ontvangt u als eerste het nieuwste aanbod, kunt u eenvoudig bezichtigingen inplannen en heeft u direct contact met onze makelaars. Uw gegevens worden veilig opgeslagen en u bepaalt zelf welke notificaties u ontvangt. Binnen enkele minuten heeft u toegang tot alle extra functies die het zoeken naar een woning een stuk eenvoudiger maken. Bovendien is registratie volledig gratis en vrijblijvend.</p>
          </div>
...
export default function SignupPage() {
  useEffect(() => {
    document.title = 'Registreren | Van der Berg Makelaardij'
  }, [])
